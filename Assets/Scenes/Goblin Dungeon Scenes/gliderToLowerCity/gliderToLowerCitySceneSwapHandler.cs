...
public class gliderToLowerCitySceneSwapHandler : MonoBehaviour
{
    ...
    {
        //---------------------GLIDER TO LOWER CITY--------------------
        if (this.gameObject.name == "entryToLowerCityEntranceFromGlider")
        {
            sceneSwapHolder.enteredWay = "entryToLowerCityEntranceFromGlider";
        ...
        //---------------------GLIDER TO SEWAGE--------------------
        if (this.gameObject.name == "entryTosewageWithFishFromgliderToLowerCity")
        {
            sceneSwapHolder.enteredWay = "entryTosewageWithFishFromgliderToLowerCity";
