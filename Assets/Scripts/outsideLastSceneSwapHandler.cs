...
public class outsideLastSceneSwapHandler : MonoBehaviour
{
    //Timers
    ...
    private void handleSceneSwap()
    {
        ...
        if (this.gameObject.name == "entryTocavernFourFromoutsideLast")
        {
            sceneSwapHolder.enteredWay = "entryTocavernFourFromoutsideLast";
