...
public class cavernOfIllusionsSceneSwapHandler : MonoBehaviour
{
    //Timers
    ...
    {
        //---------------------CAVERN OF ILLUSIONS TO SNOWY LAKE--------------------
        if (this.gameObject.name == "entryToSnowyLakeFromcavernOfIllusions")
        {
            sceneSwapHolder.enteredWay = "entryToSnowyLakeFromcavernOfIllusions";
        ...
        //---------------------CAVERN OF ILLUSIONS TO CAVERN TWO--------------------

        if (this.gameObject.name == "entryTocavernTwoFromcavernOfIllusions")
        {
            sceneSwapHolder.enteredWay = "entryTocavernTwoFromcavernOfIllusions";
