...
public class desertedTownSceneSwapHandler : MonoBehaviour
{
    ...
    {
        //---------------------SEWAGE TO PRISON--------------------
        if (this.gameObject.name == "entryTobuildingsInnerFromdesertedTown")
        {
            sceneSwapHolder.enteredWay = "entryTobuildingsInnerFromdesertedTown";
