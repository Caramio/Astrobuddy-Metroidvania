...
public class cavernFourSceneSwapHandler : MonoBehaviour
{
    //Timers
    ...
    {
        //---------------------OUTSIDELAST TO CAVERNFOUR--------------------
        if (this.gameObject.name == "entryTooutsideLastFromcavernFour")
        {
            sceneSwapHolder.enteredWay = "entryTooutsideLastFromcavernFour";
            sceneToLoad = "outsideLast";
