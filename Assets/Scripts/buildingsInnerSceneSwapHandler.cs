...
public class buildingsInnerSceneSwapHandler : MonoBehaviour
{
    ...
    {
        //---
        if (this.gameObject.name == "entryTodesertedTownFrombuildingsInner")
        {
            sceneSwapHolder.enteredWay = "entryTodesertedTownFrombuildingsInner";
        ...
        if (this.gameObject.name == "entryToruinedKingdomCorridorFrombuildingsInner")
        {
            sceneSwapHolder.enteredWay = "entryToruinedKingdomCorridorFrombuildingsInner";
